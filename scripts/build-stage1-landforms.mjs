...
const landforms = [
  ...
  { id: 'lf-gate-descent-terrace', frame: 7, x: 7900, y: 344, width: 700, height: 330, depth: 12.16, alpha: 0.9, flipX: true, sectionId: 'lantern-warden-gate' },
  { id: 'lf-gate-rest-stonewall', frame: 0, x: 8380, y: 430, width: 650, height: 350, depth: 12.12, alpha: 0.9, flipX: false, sectionId: 'lantern-warden-gate' },
...
const colliders = [
  ...
  collider('lc-sign-low-attached-ledge-top', 'lf-sign-low-attached-ledge', 'wall-kick-sign-shaft', 1680, 430, 260, 30),
  collider('lc-sign-mid-wall-ledge-top', 'lf-sign-mid-wall-ledge', 'wall-kick-sign-shaft', 1940, 310, 260, 28),
  collider('lc-sign-high-tower-ledge-top', 'lf-sign-high-tower-ledge', 'wall-kick-sign-shaft', 2160, 235, 260, 28),
  collider('lc-sign-roof-bridge-top', 'lf-sign-roof-bridge', 'wall-kick-sign-shaft', 2400, 175, 740, 30),

  collider('lc-central-drop-roof-wall-top', 'lf-central-drop-roof-wall', 'rooftop-hazard-line', 3140, 320, 620, 42),
  collider('lc-central-market-left-top', 'lf-central-market-roof-left', 'rooftop-hazard-line', 3760, 320, 440, 42),
  collider('lc-central-market-right-top', 'lf-central-market-roof-right', 'rooftop-hazard-line', 4200, 320, 480, 42),
  collider('lc-market-drain-bank-top', 'lf-market-drain-bank', 'rooftop-hazard-line', 4680, 320, 800, 42),
  ...
  collider('lc-thorn-exit-roof-left-top', 'lf-thorn-exit-roof-left', 'neon-thorn-climb', 6560, 170, 420, 28),
  collider('lc-thorn-exit-roof-right-top', 'lf-thorn-exit-roof-right', 'neon-thorn-climb', 6980, 170, 340, 28),
  collider('lc-thorn-high-roof-left-top', 'lf-thorn-high-roof-left', 'neon-thorn-climb', 7320, 245, 380, 30),
  collider('lc-thorn-high-roof-right-top', 'lf-thorn-high-roof-right', 'neon-thorn-climb', 7700, 245, 280, 30),

  collider('lc-gate-descent-terrace-top', 'lf-gate-descent-terrace', 'lantern-warden-gate', 7980, 405, 480, 42),
  collider('lc-gate-rest-stonewall-top', 'lf-gate-rest-stonewall', 'lantern-warden-gate', 8460, 500, 440, 42),
